    ...
    try {
        ...
        if (!locationResult) {
            ...
            return {
                ...
                body: JSON.stringify({
                    success: false,
                    message: "Location could not be deactivated"
                })
            };
        }
...
app.listen(PORT, () => {
    ...
    console.log(
        `Deactivate Location API running on port ${PORT}`
    );
